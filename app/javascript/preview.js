document.addEventListener('DOMContentLoaded', function(){
  // 新規投稿・編集ページのフォームを取得
  const photographForm = document.getElementById('new_post');
...
const buildNewFileField = () => {
  ...
  newFileField.setAttribute('name', 'photograph[images][]');

  // 最後のfile_fieldを取得
  const lastFileField = document.querySelector('input[type="file"][name="photograph[images][]"]:last-child');
